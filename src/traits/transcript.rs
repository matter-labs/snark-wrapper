...
pub trait CircuitGLTranscript<E: Engine>: Clone + Send + Sync + std::fmt::Debug {
    ...
    fn new<CS: ConstraintSystem<E>>(
        cs: &mut CS, 
        params: Self::TranscriptParameters
    ...
    fn get_multiple_challenges_fixed<CS: ConstraintSystem<E>, const N: usize>(
        &mut self,
        cs: &mut CS,
    ...
    fn get_multiple_challenges<CS: ConstraintSystem<E>>(
        &mut self,
        cs: &mut CS,
...
impl BoolsBuffer {
    pub fn get_bits<E: Engine, CS: ConstraintSystem<E>, T: CircuitGLTranscript<E>>(
        &mut self,
        cs: &mut CS,
        transcript: &mut T,
        num_bits: usize,
