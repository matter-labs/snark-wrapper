...
impl ConstantsHolder {
    pub fn generate<E: Engine, CS: ConstraintSystem<E>>(
        ...
        result.num_lookup_subarguments = SizeCalculator::<GL, 2, GLExt2>::num_sublookup_arguments(
            &verifier.parameters,
            &verifier.lookup_parameters,
        );
        result.num_variable_polys = SizeCalculator::<GL, 2, GLExt2>::num_variable_polys(
            &verifier.parameters,
            verifier.total_num_variables_for_specialized_columns,
        );
        result.num_witness_polys = SizeCalculator::<GL, 2, GLExt2>::num_witness_polys(
            &verifier.parameters,
            verifier.total_num_witnesses_for_specialized_columns,
        );
        result.num_constant_polys = SizeCalculator::<GL, 2, GLExt2>::num_constant_polys(
            &verifier.parameters,
            fixed_parameters,
            verifier.total_num_constants_for_specialized_columns,
        );
        result.num_multiplicities_polys = SizeCalculator::<GL, 2, GLExt2>::num_multipicities_polys(
            &verifier.lookup_parameters,
        ...
        result.compute_total_num_challenges_for_fri_quotiening(
            verifier
        );
